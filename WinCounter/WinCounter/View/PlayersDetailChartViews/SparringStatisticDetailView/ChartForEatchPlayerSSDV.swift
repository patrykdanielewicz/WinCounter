...
struct ChartForEachPlayerSSDV: View {
    ...
    var body: some View {
            ...
            .onAppear {
                dataForCharts = DataForChartsPreparation.dataForEachOpponentsPerSparring(opponentsWinLossesDictionary: DataForSparringsDetailView.playersEachOpponentsStats(sparrings: sparrings, player: player))
                print(DataForSparringsDetailView.playersEachOpponentsStats(sparrings: sparrings, player: player))
            }
        }
